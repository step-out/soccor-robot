...
bool Client::GotoPos(double object_x, double object_y) 
{
    if (CalDist(x, y, object_x, object_y) < MARGIN)
        return 0;
    else
    {
        Dash(100, SubAng(CalDir(x, y, object_x, object_y), body_global_angle));
        return 1;
    }
}
